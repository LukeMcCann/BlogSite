...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center bg-dark text-white">Edit Post</div>
                    ...
                    <div class="card-body text-center bg-dark text-white">
                        <form method="POST" action="{{ url('/editPost', array($posts->id)) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ $posts->post_title }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <textarea id="content" rows="20" class="form-control {{ $errors->has('content') ? ' is-invalid' : '' }}" name="content" required>{{ $posts->post_content }}</textarea>
